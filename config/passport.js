...
// Türkçe karakterleri İngilizce'ye çevir ve kullanıcı adı oluştur
...
module.exports = function(passport) {
    ...
    passport.use(new GoogleStrategy({
        ...
        try {
            ...
            // ad_soyad'dan otomatik kullanıcı adı oluştur (örn: "Ufuk Güney Doğdu" -> "ufukguneydogdu")
            const autoUsername = await generateUsernameFromName(profile.displayName);
            ...
            const userId = await db.insert(
                ...
                [profile.id, email, profile.displayName, autoUsername, profile.photos[0]?.value || null]
            );
